...
def isWinner(x, nums):
    ...
    Args:
        ...
        nums (List[int]): An array of n values representing the maximum integer for each round.
    ...
    def get_primes(n):
        """
        Returns a list of all prime numbers up to and including a given maximum value.
    ...
    def play_game(n):
        """
        Simulates a single round of the game and returns the name of the winner.
